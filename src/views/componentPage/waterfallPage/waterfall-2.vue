<template>
  <div class="main-container">
    <div class="main-content">
          ...
          <div class="card">
            ...
            <div class="name">
              <p>
                height:{{
                  `${Math.floor(
                    (props.data.itemWidth / props.data.width) *
                      props.data.height
                  )}px`
                }}
              </p>
      ...
      <div class="add-more">
        <button class="button" @click="addNewList">Add More</button>
      </div>
    </div>
    <div
      class="slide-menu"
    ...
    >
      <div class="operations" :style="{ width: `${slideWidth}px` }">
        <div class="item">
          <p class="title">进入效果</p>
          <el-select v-model="effect" placeholder="请选择" style="width:100%">
            <el-option
        ...
        <div class="item">
          ...
          <el-input-number v-model="duration" :min="0" style="width:100%" />
        </div>
        <div class="item">
          <p class="title">延迟时间</p>
          <el-input-number v-model="delay" :min="0" style="width:100%" />
        </div>
        <div class="item">
          <p class="title">设置初始高度颜色</p>
          <el-switch v-model="isSetInitStyle" @change="changeState" />
        </div>
        <div class="item">
          <el-button
            v-if="slideWidth === 200"
            ...
            >缩小窗口</el-button
          >
          <el-button v-else style="width:100%" @click="shrinkWrapper(200)"
            >恢复窗口</el-button
          >
        </div>
        <div class="github">
